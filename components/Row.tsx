...
function Row({ title, movies }: Props) {
	...
	const onRowScroll = () => {
		...
		if (scrollWidth - (scrollLeft + clientWidth) <= thumbnailRef.current.offsetWidth * 0.1) {
			// Hide right button
  ...
  return (
	...
	">
		...
		<div className="relative group md:-ml-2">
			<ChevronLeftIcon ref={leftButton} className="
			...
			<ChevronRightIcon ref={rightButton} className="
